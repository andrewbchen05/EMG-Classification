...
class LSTMEncoder(nn.Module):
  """A LSTM-based encoder using sequence of 'LSTM' layers.

  Args:
      num_features (int): The number of expected features in the input.
      lstm_hidden_size (int): The number of features in the hidden state.
      num_lstm_layers (int): Number of recurrent layers.
  """
...
class GRUEncoder(nn.Module):
  """A GRU-based encoder using sequence of 'GRU' layers.

  Args:
      num_features (int): The number of expected features in the input.
      gru_hidden_size (int): The number of features in the hidden state.
      num_gru_layers (int): Number of recurrent layers.
  """
